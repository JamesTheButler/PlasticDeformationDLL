...
bool initFromFile(string fileName) {
	...
	logger::log("--init from file "+fileName);
	...
	_initExecutionTimes[6] = chrono::duration_cast<chrono::milliseconds>(initStopTime - initStartTime).count();
...
void storeData() {
	...
	Serialization::save(
		_tetrahedralizationPath + _fileName + ".tetMesh",
		_tetMeshVertices,
		_tetMeshTetrahedra,
		_surfaceVertices,
		_surfaceVertexToTetVertexMap,
