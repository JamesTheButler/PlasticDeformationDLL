...
const void writeTetMeshDataToFile(
...
//	const std::vector<glm::ivec4> &tetMeshTets,
	...
	std::string fileName = "F:\\Eigene Dateien\\Studium\\Master Schweden\\9 Master Thesis\\Practical\\MasterThesisPrototype\\Assets\\output.tetmesh";
